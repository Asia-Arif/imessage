...
function ChatPage() {
   ...
   *
   * We do NOT pass activeConversationId here.
   * The store checks the currently open conversation itself.
   *
   * This allows messages from other users to trigger
   * the unread blue dot in real time.
   */
  useEffect(() => {
    subscribeToMessages();
